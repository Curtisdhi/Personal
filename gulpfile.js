...
gulp.task('build:css:vendors', function() {
    return gulp.src(['assets/vendors/materialize/dist/css/materialize.css',
...
gulp.task('deploy:fonts', function() {
    return gulp.src(['assets/vendors/materialize/dist/fonts/*',
        'assets/vendors/materialize/dist/fonts/**',
